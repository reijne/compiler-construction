...
extern node *CHKcomma (node * arg_node, info * arg_info);
...
extern node *CHKfunbodyblock (node * arg_node, info * arg_info);
...
extern node *CHKl_curly_bracket (node * arg_node, info * arg_info);
...
extern node *CHKr_curly_bracket (node * arg_node, info * arg_info);
extern node *CHKsemicolon (node * arg_node, info * arg_info);
...
extern node *CHKfloat (node * arg_node, info * arg_info);
extern node *CHKbool (node * arg_node, info * arg_info);
extern node *CHKvoid (node * arg_node, info * arg_info);
extern node *CHKnum (node * arg_node, info * arg_info);
extern node *CHKfloat (node * arg_node, info * arg_info);
extern node *CHKbool (node * arg_node, info * arg_info);
extern node *CHKassign (node * arg_node, info * arg_info);
